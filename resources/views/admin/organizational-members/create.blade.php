    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="m-0 fw-bold text-primary">Form Tambah Anggota Organisasi</h6>
                <a href="{{ route('admin.pages.organizational-members.index', $page) }}" class="btn btn-secondary btn-sm">
                    <i class="fas fa-arrow-left me-1"></i>Kembali
                </a>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.pages.organizational-members.store', $page) }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="text-center">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="initialsPreview" class="initials-preview bg-primary text-white d-flex align-items-center justify-content-center mx-auto">
                                ...
                                <div class="photo-upload-area p-4 text-center">
                                    ...
                                    <div class="form-text mt-2">
                                        ...
                                        Disarankan ukuran persegi (1:1) untuk hasil terbaik.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Informasi tambahan tentang anggota ini...">{{ old('description') }}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
...
$(function() {
    ...
    // Initialize initials
    updateInitials(nameInput.value);
});
</script>
@endpush
